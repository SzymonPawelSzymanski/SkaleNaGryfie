...
{
    internal class HowToState : Component//dziedziczy wszycho po klasie State (astrakcyjnej ktora sluzy tylko do dziedziczenia)
    {
...
namespace Skalenagryfie1.Content.States
{
    internal class HowToState : Component
    {
        private List<Component> _components;
        private Texture2D teksturaGryfu;
        ...
        public override void Draw(SpriteBatch spriteBatch)
            ...
            var tekstW = teksturaGryfu.Width;
            var tekstH = teksturaGryfu.Height;
            //foreach (var component in _components)
            spriteBatch.Draw(teksturaGryfu, new Rectangle(1, 1, tekstW, tekstH), Color.White);
            }
